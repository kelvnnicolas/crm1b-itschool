...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      tasks: {
        Row: {
          ...
          entity_type: Database["public"]["Enums"]["task_entity_type"] | null
          id: string
          organization_id: string
    ...
    Enums: {
      note_entity_type: "contact" | "lead"
      task_entity_type: "contact" | "lead"
      task_status: "pending" | "completed" | "cancelled"
      user_role: "admin" | "commercial" | "teacher" | "operational"
    }
    CompositeTypes: {
      [_ in never]: never
    }
